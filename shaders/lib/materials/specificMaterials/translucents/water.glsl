#include "/lib/atmospherics/ratlantisWater.glsl"
// ============================== Step 1: Color Prep ============================== //
...
#define PHYSICS_OCEAN_INJECTION
    ...
    float waterBumpNoise = 1.0;
        ...
        vec3 normalMap = vec3(0.0, 0.0, 1.0);
            ...
            #define WATER_BUMPINESS_M WATER_BUMPINESS * 0.8
                ...
                #ifdef LUX_WATER_NORMALS
                    // ---- Lux Shader v1.2 wave normals (finite-difference) ----
                    normalMap.xy = GetLuxWaterSlopes(worldPos);
    ...
    // ============================== Step 3: Water Material Features ============================== //
        ...
        if (isEyeInWater != 1) {
            ...
            #ifdef LUX_WATER_NORMALS
                color.rgb *= GetLuxWaterAbsorption(lViewPosDifM, LUX_MURKINESS);
            #endif
